...
namespace Website.layouts.Pages.Marketing.Historical_Rates
{
    public partial class historical_rates_texas : BaseLayout
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rptGreenAndCleanVariablePricePlan.ItemDataBound += rptGreenAndCleanVariablePricePlan_ItemDataBound;
            ...
            rptFlexChoicePlan.ItemDataBound += rptFlexChoicePlan_ItemDataBound;
            ...
            rptFlexChoicePlanGreenAndCleanPlan.ItemDataBound += rptFlexChoicePlanGreenAndCleanPlan_ItemDataBound;
        ...
        void rptGreenAndCleanVariablePricePlan_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            var item = e.Item.DataItem as Item;
            var table = e.Item.FindControl("table") as HtmlTable;
            var tdDate = e.Item.FindControl("tdDate") as HtmlTableCell;
        ...
        void rptFlexChoicePlan_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            var item = e.Item.DataItem as Item;
            var table = e.Item.FindControl("table") as HtmlTable;
            var tdDate = e.Item.FindControl("tdDate") as HtmlTableCell;
        ...
        void rptFlexChoicePlanGreenAndCleanPlan_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            var item = e.Item.DataItem as Item;
            var table = e.Item.FindControl("table") as HtmlTable;
            var tdDate = e.Item.FindControl("tdDate") as HtmlTableCell;
