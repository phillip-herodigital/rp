...
<div class="experience-explorer">
  <div class="panel editor">
    ...
    <button type="button" class="page-editor-button" onclick="javascript:window.top.location.href='/?sc_mode=edit&sc_itemId=<%= Sitecore.Context.Item.ID.ToString() %>';"><%= ExperienceExplorerUtil.TranslateText("ExperienceEditor") %></button>
