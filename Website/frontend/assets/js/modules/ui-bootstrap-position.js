...
//REPLACEMENT POSITION FACTORY FOR TOOLTIP FIX updates around line 103
                ...
                var shiftWidth = {
                    center: function () {
                        ...
                        if(appendToBody){
                            ...
                            if(toReturn < 0 && windowEl.width > targetElRight){
                                targetEl.addClass("top-offset-right");
                                toReturn = hostElPos.left;
                            }else if(windowEl.width < targetElRight){
                                targetEl.addClass("top-offset-left");
                                toReturn = (hostElPos.left +5) - (targetElWidth - hostElPos.width);
                            }
                        }
                        return toReturn;
                    },
