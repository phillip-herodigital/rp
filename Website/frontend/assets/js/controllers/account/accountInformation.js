 ...
 *
 */
ngApp.controller('AcctAccountInformationCtrl', ['$scope', '$rootScope', '$http', 'scrollService', function ($scope, $rootScope, $http, scrollService) {
        ...
        if (newVal) {
            ...
            $http({
                ...
                .success(function (data, status, headers, config) {
                    ...
                    if (typeof($scope.formData.serviceAddresses) != 'undefined') {
