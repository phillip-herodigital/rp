  ...
  return sitecore.Definitions.App.extend({
    initialized: function () {
      ...
      this.on({
        ...
        "senderdialog:hide": this.hideDialog,
        "senderdialog:submit": this.submitAction,
    ...
    submitAction: function () {
      ...
      contextItem.EmailAddress = email;
      ...
      if (contextItem.isValid()) {
        ...
        contextItem.save()
          .then(function () {
            self.hideDialog();
            sitecore.trigger("sender:changed", contextItem, "add");
          }).fail(function (error) {
            ...
            if (errorMessage.length > 0 && errorMessage !== "Operation failed.") {
              ...
              message = sitecore.Resources.Dictionary.translate("The approved sender \"{0}\" could not be added.") + " " +
                sitecore.Resources.Dictionary.translate("Please try again later.");
            }

            message = sitecore.Helpers.string.format(message, contextItem.EmailAddress);
    ...
    itemChanged: function () {
      ...
      this.EmailTextBox.set("text", contextItem.EmailAddress);
    ...
    trackChanges: function () {
      this.EmailTextBox.viewModel.$el.on("cut input paste keyup", _.bind(function (event) {
        this.updateSaveButtonState(event, this.EmailTextBox.viewModel.$el.val(), "EmailAddress");
      }, this));
    },
    ...
    updateSaveButtonState: function (event, value, property) {
      ...
      (contextItem[property] !== value ||
        emailValue !== contextItem["EmailAddress"]);
