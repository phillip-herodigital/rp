define(["sitecore", "/-/speak/v1/ecm/ServerRequest.js"], function (sitecore) {
  return {
    ...
    execute: function (context) {
      postServerRequest("ecm.importnewhtmllayout.import", { fileItemId: context.currentContext.fileItemId, fileName: context.currentContext.fileName, database: context.currentContext.database }, function (response) {
        if (response.error) {
