      ...
      function () {
        ...
        */
        Column.prototype.resizeDebounceHandler = function () {
          ...
          models.nvd3Axis.createXaxis(this.ChartProperties.svgElement, this.ChartProperties.componentElement, this.ChartProperties.margin, false, false, this.CategoryLabelTrimming);
       ...
       */
        ...
        */
        Column.prototype.resize = function () {
          ...
          models.nvd3Axis.ellipseXLabels(this.ChartProperties.svgElement, this.CategoryLabelTrimming, this.CategoryLabelTrimming, this.ChartProperties.chartElement.xAxis.rangeBand());
        ...
        */
        Column.prototype.bindData = function (data, isAnimationEnabled) {          
          ...
          nv.addGraph(function () {
            ...
            models.nvd3Axis.ellipseXLabels(this.ChartProperties.svgElement, this.CategoryLabelTrimming, this.ChartProperties.chartElement.xAxis.rangeBand());
