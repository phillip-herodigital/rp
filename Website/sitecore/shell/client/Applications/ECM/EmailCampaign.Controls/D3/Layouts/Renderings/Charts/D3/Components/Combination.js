      ...
      function () {
        ...
        */
        Combination.prototype.resizeDebounceHandler = function () {
          ...
          models.nvd3Axis.createXaxis(this.ChartProperties.svgElement, this.ChartProperties.componentElement, this.ChartProperties.margin, false, this.ChartProperties.hasBarSeries, this.CategoryLabelTrimming);
          if (this.ChartProperties.hasBarSeries) {
            models.nvd3Axis.removeXaxisMinMax(this.ChartProperties.svgElement);
          ...
          if (!this.ChartProperties.chartElement) {
            ...
            this.ChartProperties.chartElement.legend.dispatch.legendClick = function (d) {              
              if (this.ChartProperties.legendMode === models.constants.legendMode.multipleCheck) {
                ...
                if (this.ChartProperties.hasBarSeries && this.ChartProperties.chartData[this.ChartProperties.barSeriesIndex].legendState !== models.constants.legendState.unchecked) {
                  models.nvd3Axis.removeXaxisMinMax(this.ChartProperties.svgElement, this.ChartProperties.chartData[this.ChartProperties.barSeriesIndex].values.length);
                }
