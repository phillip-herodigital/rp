      ...
      function () {
        ...
        */
        Line.prototype.resizeDebounceHandler = function () {
          ...
          models.nvd3Axis.createXaxis(this.ChartProperties.svgElement, this.ChartProperties.componentElement, this.ChartProperties.margin, true, false, this.CategoryLabelTrimming);
           ...
           .options({
            ...
            this.ChartProperties.chartElement.legend.dispatch.legendClick = function (d) {              
              if (this.ChartProperties.legendMode === models.constants.legendMode.multipleCheck) {
                ...
                //models.nvd3Axis.createXaxis(this.ChartProperties.svgElement, this.ChartProperties.componentElement, this.ChartProperties.margin);
              }
            }.bind(this);
          }
        };
