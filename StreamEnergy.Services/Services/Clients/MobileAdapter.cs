    ...
    class MobileAdapter : ILocationAdapter
    {
        ...
        private Offer GenerateSingleOffer(dynamic product, SitecoreProductInfo productData, dynamic childOffer, bool isChildOffer)
        {
            ...
            return new Mobile.Offer
            {
                ...
                DisplayPlan = productData.Fields["Display Plan"] == "1" ? true : false,
                NonAutoPayID = productData.Fields["Non-AutoPay ID"],
                WithAutoPayID = productData.Fields["With-AutoPay ID"],
        ...
        dynamic ILocationAdapter.ToEnrollmentAccount(Guid globalCustomerId, EnrollmentAccountDetails account, bool IsAutoPayEnabled)
        {
