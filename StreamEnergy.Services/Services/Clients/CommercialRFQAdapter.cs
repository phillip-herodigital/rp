...
namespace StreamEnergy.Services.Clients
{
    class CommercialRFQAdapter : ILocationAdapter
    {
        ...
        {
            return location.Capabilities.OfType<TexasElectricity.ServiceCapability>().Any() && location.Capabilities.OfType<CustomerTypeCapability>().Any(cap => cap.CustomerType == EnrollmentCustomerType.Commercial);
        }
