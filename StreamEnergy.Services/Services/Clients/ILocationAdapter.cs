...
namespace StreamEnergy.Services.Clients
{
    public interface ILocationAdapter
    {
        ...
        dynamic ToEnrollmentAccount(Guid globalCustomerId, EnrollmentAccountDetails account, bool IsAutoPayEnabled, string ExistingAccountNumber, DateTime DOB, string Gender);
