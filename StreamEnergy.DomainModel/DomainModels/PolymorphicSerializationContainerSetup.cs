        ...
        void IContainerSetupStrategy.SetupUnity(IUnityContainer unityContainer)
        {
            ...
            unityContainer.Resolve<TypeIndicatorJsonConverter>().TypeIndicators.Add(new TypeIndicatorLookup<Enrollments.IOfferOption, Enrollments.SampleOfferOption>(sc => sc.OptionType)
            {
                SupportedTypes = {
                    ...
                    { Enrollments.DCElectricity.OfferOption.Qualifier, typeof(Enrollments.DCElectricity.OfferOption) },
                    ...
                    { Enrollments.MarylandElectricity.OfferOption.Qualifier, typeof(Enrollments.MarylandElectricity.OfferOption) },
                    ...
                    { Enrollments.MarylandGas.OfferOption.Qualifier, typeof(Enrollments.MarylandGas.OfferOption) },
                    ...
                    { Enrollments.PennsylvaniaElectricity.OfferOption.Qualifier, typeof(Enrollments.PennsylvaniaElectricity.OfferOption) },
                    ...
                    { Enrollments.PennsylvaniaGas.OfferOption.Qualifier, typeof(Enrollments.PennsylvaniaGas.OfferOption) },
