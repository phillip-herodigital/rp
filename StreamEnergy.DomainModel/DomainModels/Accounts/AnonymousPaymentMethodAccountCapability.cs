...
{
    [Serializable]
    public class AnonymousPaymentMethodAccountCapability : IAccountCapability
    {
        public const string Qualifier = "PaymentMethod";

        public AnonymousPaymentMethodAccountCapability(List<AvailablePaymentMethod> availablePaymentMethods = null)
        {
