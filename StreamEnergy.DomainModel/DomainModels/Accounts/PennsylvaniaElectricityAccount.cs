...
namespace StreamEnergy.DomainModels.Accounts
{
    ...
    public class PennsylvaniaElectricityAccount : ISubAccount
    {
        ...
        {
            get { return PennsylvaniaElectricityAccount.Qualifier; }
        }

        public string Key
        {
            get { return PennsylvaniaElectricityAccount.Classification; }
        }
