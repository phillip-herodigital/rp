...
namespace StreamEnergy.DomainModels.Accounts
{
    ...
    public class NewYorkElectricityAccount : ISubAccount
    {
        ...
        {
            get { return NewYorkElectricityAccount.Qualifier; }
        }

        public string Key
        {
            get { return NewYorkElectricityAccount.Classification; }
        }
