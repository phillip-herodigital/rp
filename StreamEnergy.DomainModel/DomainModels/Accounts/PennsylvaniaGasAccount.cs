...
namespace StreamEnergy.DomainModels.Accounts
{
    ...
    public class PennsylvaniaGasAccount : ISubAccount
    {
        ...
        {
            get { return PennsylvaniaGasAccount.Qualifier; }
        }

        public string Key
        {
            get { return PennsylvaniaGasAccount.Classification; }
        }
