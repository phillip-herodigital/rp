...
namespace StreamEnergy.DomainModels.Accounts
{
    ...
    public class NewJerseyElectricityAccount : ISubAccount
    {
        ...
        {
            get { return NewJerseyElectricityAccount.Qualifier; }
        }

        public string Key
        {
            get { return NewJerseyElectricityAccount.Classification; }
        }
