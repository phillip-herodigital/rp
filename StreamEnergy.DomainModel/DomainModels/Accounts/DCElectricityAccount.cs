...
namespace StreamEnergy.DomainModels.Accounts
{
    ...
    public class DCElectricityAccount : ISubAccount
    {
        ...
        {
            get { return DCElectricityAccount.Qualifier; }
        }

        public string Key
        {
            get { return DCElectricityAccount.Classification; }
        }
