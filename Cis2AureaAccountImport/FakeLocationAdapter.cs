...
namespace Cis2AureaAccountImport
{
    class FakeLocationAdapter : ILocationAdapter
    {
        ...
        public dynamic ToEnrollmentAccount(Guid globalCustomerId, EnrollmentAccountDetails account, bool IsAutoPayEnabled, string ExistingAccountNumber, DateTime DOB, string Gender)
        {
            throw new NotImplementedException();
        }
